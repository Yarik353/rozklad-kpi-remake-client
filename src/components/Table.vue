...
export default {
  ...
  methods: {
    /**
     * Функція формує зручний масив із розкладом групи для зручного порядкового заповнення таблиці
     * @param time час початку пари
     * @param week тиждень (перший або другий)
     * @returns {*[][]} Двовимірний масив з усіма парами на вказаний час та тиждень у зручному порядку
     */
